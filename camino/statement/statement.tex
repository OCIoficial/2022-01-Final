...
\begin{problemDescription}
  ...
  Partiendo de la casilla $(1, 1)$ (esquina superior izquierda) en cada turno uno puede moverse desde
  ...
  El objetivo del juego es llegar a la casilla $(M, N)$ (esquina inferior derecha) sumando
  ...
  arriba, no obstante estos puntajes son irrelevantes pues uno nunca puede moverse a
  estas casillas desde arriba.
